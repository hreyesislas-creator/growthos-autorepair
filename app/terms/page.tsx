...
export const metadata: Metadata = {
  title: 'Terms and Conditions | E&E Tires',
  description:
    'Terms and Conditions for E&E Tires, including SMS communications and service-related messaging practices.',
}
        ...
        <div className="wrap">
          <div className="nav-inner">
            ...
            <div className="nav-links">
              ...
              <Link className="nav-lnk cur" href="/terms">
                Terms
              </Link>
              <Link className="nav-lnk" href="/privacy">
                Privacy
              </Link>
            </div>
          ...
          >
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={{ marginBottom: 12 }}>
                By accessing <a href="https://eetires.com">eetires.com</a>, scheduling services with E&amp;E Tires (&quot;we,&quot;
                &quot;us,&quot; or &quot;our&quot;), or otherwise using our services, you agree to these Terms and Conditions. If you do not
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={{ marginBottom: 12 }}>
                E&amp;E Tires provides automotive repair, maintenance, tire services, inspections, and related vehicle services at our
                facility and through communications reasonably necessary to coordinate those services. We may update the scope of services,
                hours, or availability; any material limits will be communicated when practical.
              </p>
            </section>
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={{ marginBottom: 12 }}>
                Appointment requests (including online, by phone, or by SMS) are scheduling requests unless we confirm otherwise.
                You are responsible for providing accurate contact and vehicle information. We may reschedule or decline service when
                necessary for safety, capacity, or operational reasons.
              </p>
            </section>
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={{ marginBottom: 12 }}>
                Written or verbal estimates describe proposed work and pricing in good faith; actual charges may vary if additional
                authorized or necessary work is discovered during diagnosis. Diagnostic results, repair status, and estimate follow-ups may
                be communicated by phone, email, SMS, or other channels you have provided, limited to service-related messages (not
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={{ marginBottom: 12 }}>
                We may send SMS messages for customer support conversations, appointment confirmations, service updates, repair status
                notifications, missed-call follow-ups, and estimate-related communications. We do not use SMS for marketing or promotional
                campaigns.
              </p>
              <p
                style={{
              ...
              >
                By providing your phone number, you consent to receive service-related SMS messages from E&amp;E Tires. Message frequency
                varies. Message and data rates may apply. Reply STOP to opt out. Reply HELP for help. Consent is not a condition of purchase.
              </p>
            </section>
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={{ marginBottom: 12 }}>
                You may opt out of SMS at any time by replying <strong>STOP</strong> to any message from us. After opting out, you may
                receive a one-time confirmation. For assistance, reply <strong>HELP</strong> or contact us using the information below.
                You may still receive non-SMS communications necessary to complete transactions you have requested.
              </p>
            </section>
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={{ marginBottom: 12 }}>
                To the fullest extent permitted by law, E&amp;E Tires is not liable for any indirect, incidental, special, consequential,
                or punitive damages arising from your use of our services or communications. Our total liability for any claim relating to
                services or these terms is limited to the amount you paid us for the specific service giving rise to the claim during the
                three (3) months before the claim, unless applicable law requires otherwise. Some jurisdictions do not allow certain
                limitations; in those cases, our liability is limited to the maximum extent permitted.
              </p>
            </section>
            ...
            <section style={{ marginBottom: 28 }}>
              ...
              <p style={{ marginBottom: 12 }}>
                ...
                Continued use of our services after changes constitutes acceptance of the updated Terms, except where your separate consent
                is required by law.
              </p>
            </section>
