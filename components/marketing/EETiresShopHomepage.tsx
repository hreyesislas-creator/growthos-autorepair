// Public shop homepage HTML (eetires.com root only — see app/page.tsx).
// Interactivity: nav toggle, carousel, form via SiteScripts.
import SiteScripts from '@/components/SiteScripts'

export default function EETiresShopHomepage() {
  const html = `
